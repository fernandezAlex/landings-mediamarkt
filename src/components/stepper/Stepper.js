...
import MultipleOptions from '../form/MultipleOptions'
...
const updateMultipleOption = (option) => {
    ...
    function getSteps() {
    return ['Elige el servicio que te gustaría.', 'Déjanos tus datos.', 'Nos pondremos en contacto contigo para informarte'];
    }
    ...
    return (
        // <div className={[classes.root, " section__"]}>
        <div className={classes.root + " section__"}>

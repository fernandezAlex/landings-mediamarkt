export const cardsSection = [
    {
      title: "Hospitality",
      content: `Solución de entretenimiento para hoteles basada en <strong>Google Chromecast®</strong>
      el huésped podrá disfrutar de sus contenidos
      ...
      <strong>Desde 142€ / habitación*</strong>`,
      imgThumbnail:
    ...
    {
      title: "",
      content: `Nuestro <strong>kiosko tablet</strong> te permite incorporar una solución de
    ...
    {
      title: "Comercio",
      content: `Con la solución de <strong>cartelería digital</strong> podrás almacenar, organizar, programar y emitir contenidos medibles en cualquier dispositivo digital sin dificultad de uso ni freno tecnológico.
    ...
    {
      title: "",
      content: `Te ofrecemos soluciones de <strong>conectividad</strong> a medida para
    ...
    },
    {
      ...
      <strong>datáfono</strong>. Acepta cualquier medio de pago, configúralo en cinco
    ...
    },
    {
      ...
      soluciones de <strong>TPV</strong>(Terminal punto de venta).
    ...
    {
      title: "",
      content: `Garantiza del confort y bienestar de tus clientes con <strong>soluciones
      de frio, calor y purificadores de aire.</strong><br><br><br>

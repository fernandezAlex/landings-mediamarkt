export const cardsSection1 = [
    {
      ...
      content: "Asistencia inmediata: ante una incidencia o intrusión,nuestra Central Receptora de Alarmas dará respuesta enmenos de 29 segundos.<br> Aviso a la policía 24horas:nuestros profesionales están preparados para ofrecer ayuda de inmediato y avisar a la policía,24horas al día,365días al año.<br> Protección total:Te protegemos fuera de casa ante situaciones de riesgo con el servicio Contigo ycuidamos de todas tus comunicaciones connuestra seguridad digital.<br><br> Alarma inteligente: si olvidas conectar tu alarma como lo haces habitualmente, te enviaremos una notificación vía App para avisarte.<br><br> Además, con la App podrás conectar y desconectar la alarma, ver lo que pasa en tu hogar en tiempo real y muchas otras cosas más.",
    ...
    {
      title: "Y ahora llévate la mejor conexión al mejor precio,con Conecta Max.",
